...
// }
// };
document.getElementById("idMdDpf").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define _PCB_TYPE " + this.value);
	}

};
document.getElementById("idMdStd").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define _PCB_TYPE " + this.value);
	}
...
document.getElementById("idMd3001Base").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define _PCB_TYPE " + this.value);
	}
...
document.getElementById("idPanel666").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define " + this.value);
	} else {
...
document.getElementById("idPanel888").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define " + this.value);
	} else {
...
document.getElementById("idPanel999").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define " + this.value);
	} else {
...
document.getElementById("idPanel1003").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define " + this.value);
	} else {
...
document.getElementById("idPanel1004").output = function() {
	if (this.checked) {
		//ipt_str[0] = "#define " + this.value;
		ipt_str.push("#define " + this.value);
	} else {
...
document.getElementById("idPanel1005").output = function() {
	if (this.checked) {
		ipt_str.push("#define " + this.value);
	} else {
		ipt_str.push("//#define " + this.value);
...
document.getElementById("idRussian").output = function() {
	...
	//0:Eng 1:Schi 2:Fra 3:Ita 4:Deu 5:Esp 6:Tchi 7:Jap 8:Kor 9:Rus/Turky
	if (this.checked) {
		ipt_str.push("#define SUPPORT_RUSSIAN_OSD");
		//只有俄文才要定义这个
		ipt_str.push("#define _LANGUAGE  0x09");
	}
};
...
document.getElementById("selTvFormat").output = function() {
		ipt_str.push("#define  " + this.name + "	"+this.options[this.selectedIndex].text);
};
...
function print_text() {
	...
	document.getElementById("idMdStd").output();
	document.getElementById("idMdDpf").output();
	document.getElementById("idMd3001").output();
	document.getElementById("idMd3001Base").output();
	document.getElementById("idMd1004").output();

	document.getElementById("idPanel666").output();
	document.getElementById("idPanel888").output();
	document.getElementById("idPanel999").output();
	document.getElementById("idPanel1003").output();
	document.getElementById("idPanel1004").output();
	document.getElementById("idPanel1005").output();
	...
	document.getElementById("selTvFormat").output();
